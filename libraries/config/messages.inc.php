...
$strConfigExport_PDFDefaultPageSize_desc = __('The default size of generated PDF pages');
$strConfigExport_PDFDefaultPageSize_name = __('PDF page size');
...
$strConfigForm_PDF = 'PDF';
$strConfigForm_PDF_desc = __('Customize default options');
